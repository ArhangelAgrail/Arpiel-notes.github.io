http://www.templatelite.com/coffee-desk-free-wordpress-theme/

========================================
=== Coffee Desk Free WordPress Theme ===
========================================

Changing the font style of the Blog Title and Description
---------------------------------------------------------
By default, the blog title and description are using the normal font. You can change the font style by following this instruction:

Part 1: Modifying the Font Style
- Go to http://www.templatelite.com/coffee-desk-free-wordpress-theme/ and download the PSD zip file
...
- Go to the options page of the Red Light theme under "Appearance -> Coffee Desk"
